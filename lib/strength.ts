...
export const WEEKLY_PLAN: Record<DayKey, DayPlan> = {
  ...
  sun: {
    key: 'sun',
    label: 'Sunday',
    title: 'Pull-Up Capacity & Grip — Active Recovery',
    exercises: [
      { key: 'scap_pullups', name: 'Scapular Pull-ups (rings/bar) — own the hang', category: 'bodyweight', sets: 4, reps: '8' },
      { key: 'ring_row', name: 'Ring / Inverted Row — slow & controlled', category: 'accessory', sets: 4, reps: '12' },
      { key: 'band_pulldown', name: 'Band Straight-Arm Pulldown (lats)', category: 'accessory', sets: 3, reps: '15' },
      { key: 'chinups', name: 'Chin-ups — easy submax volume (bands as needed)', category: 'bodyweight', sets: 4, reps: 'submax' },
      { key: 'hammer_curl', name: 'DB Hammer Curl (biceps + brachialis)', category: 'accessory', sets: 3, reps: '12' },
      { key: 'face_pull', name: 'Band Face Pull (rear delts / shoulder health)', category: 'accessory', sets: 3, reps: '20' },
      { key: 'oh_triceps', name: 'DB Overhead Triceps Extension', category: 'accessory', sets: 3, reps: '12' },
      { key: 'wrist_curl', name: 'Wrist Curl + Reverse Wrist Curl (forearms)', category: 'accessory', sets: 3, reps: '15 each way' },
      { key: 'farmer_carry', name: "Farmer's Carry — heavy (grip)", category: 'accessory', sets: 3, reps: '40 yd' },
      { key: 'dead_hang', name: 'Dead Hang (grip endurance)', category: 'accessory', sets: 3, reps: 'max hold' },
    ],
  },
}
